  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <section className="max-w-7xl">
        ...
        {/* <h3 className="text-slate-300 text-2xl lg:text-4xl m-3 text-center">
          {getSkiSubtitle(new Date())}
        </h3> */}
      </section>
      <NeonSkiSign />
      ...
      >
        <span className="absolute inset-0 w-full h-full transition duration-300 ease-out opacity-0 bg-gradient-to-br from-white via-sky-400 to-sky-400 group-hover:opacity-100"></span>
