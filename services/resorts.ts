...
export const NewEnglandSkiResorts: SkiResort[] = [
  {
    ...
    ll: [44.421673, -72.84948],
    summary:
      "Bolton Valley is a ski resort in Vermont with over 300 acres of skiable terrain, 71 trails, and 6 lifts. It caters to all skill levels and offers snowshoeing, Nordic skiing, and backcountry skiing. The resort has lodging, dining options, and ski rentals.",
  },
  {
    id: "bromley-mountain",
  ...
  },
  {
    ...
    ll: [44.201653, -72.919006],
    summary:
      "Mad River Glen is a ski resort located in the Green Mountains of Vermont, USA. The resort is known for its challenging terrain, with over 50% of its trails designated as advanced or expert. It boasts over 2,000 vertical feet of skiing and is famous for its natural, ungroomed snow.",
  },
  {
    id: "smuggs",
    name: "Smuggler' Notch",
  ...
  },
  {
    ...
    ll: [44.055382, -71.116783],
    summary:
      "Cranmore Mountain Resort is a ski resort located in the White Mountains of North Conway, New Hampshire, USA. The resort offers over 170 acres of skiable terrain, including 57 trails and glades, and is known for its family-friendly atmosphere and varied terrain.",
  },
  {
    id: "gunstock",
    name: "Gunstock",
    ...
    averageRentalPrice: 49,
    ll: [43.551796, -71.360092],
    summary:
      "Gunstock Mountain Resort is a ski resort located in the Belknap Mountains of Gilford, New Hampshire, USA. The resort offers over 220 acres of skiable terrain, including 55 trails and glades, and is known for its family-friendly atmosphere and stunning views of Lake Winnipesaukee.",
  },
  {
    id: "king-pine",
    name: "King Pine",
  ...
  },
  {
    ...
    weekendTicketPrice: 89,
    averageRentalPrice: 49,
    ll: [43.486305, -71.842003],
    summary:
      "Ragged Mountain Resort is a ski resort located in Danbury, New Hampshire, USA. The resort offers over 250 acres of skiable terrain, including 57 trails and glades, and is known for its varied terrain, reliable snow conditions, and family-friendly atmosphere. ",
  },
  {
    id: "waterville",
    ...
    ll: [43.961613, -71.519989],
    summary:
      "Waterville Valley Resort is a ski resort located in the White Mountain National Forest in New Hampshire, USA. The resort offers over 265 acres of skiable terrain, including 62 trails and glades, and is known for its varied terrain, reliable snow conditions, and family-friendly atmosphere.",
  },
  {
    id: "saddleback",
    name: "Saddleback",
